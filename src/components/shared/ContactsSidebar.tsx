  ...
  return (
    ...
    >
      ...
      <div className="flex-1 overflow-y-auto">
        {contacts.length === 0 ? (
          <div className="flex flex-col items-center justify-center h-full text-slate-500 px-4 text-center py-12">
          ...
          contacts.map((contact) => (
            <div
              ...
              className={`px-4 py-3.5 border-b border-slate-100 cursor-pointer transition-all duration-200 ${
